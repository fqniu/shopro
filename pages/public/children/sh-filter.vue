		...
		<view class="navbar">
			...
			<view class="nav-item y-f" :class="{ current: filterIndex === 1 }" @tap="tabClick(1)">
				<view class="title-box x-f">
					...
					<view class="p-box">
						<text :class="{ active: salesOrder === 1 && filterIndex === 1 }" class="yticon cuIcon-fold"></text>
						<text :class="{ active: salesOrder === 2 && filterIndex === 1 }" class="yticon cuIcon-fold xia"></text>
					</view>
				</view>
			...
			<view class="nav-item y-f" :class="{ current: filterIndex === 2 }" @tap="tabClick(2)">
				<view class="title-box x-f">
					<text class="filter-title">附近</text>
					<view class="p-box">
						<text :class="{ active: newProdcutOrder === 1 && filterIndex === 2 }" class="yticon cuIcon-fold"></text>
						<text :class="{ active: newProdcutOrder === 2 && filterIndex === 2 }" class="yticon cuIcon-fold xia"></text>
					</view>
				</view>
...
export default {
	...
	methods: {
		...
		tabClick(index) {
			...
			if (index === 2) {
				this.newProdcutOrder = this.newProdcutOrder === 1 ? 2 : 1;
			} else {
